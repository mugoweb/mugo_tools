...
<a rel="prettyPhoto" href={$attribute.content[ $lightbox_image_class ].full_path|ezroot()} title="{* where is the alt text? *}">
...
{ezscript_require( array( 'ezjsc::jquery', 'jquery.prettyPhoto.js' ) )}
